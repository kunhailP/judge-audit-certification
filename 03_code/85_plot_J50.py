...
d = pd.read_csv(os.path.join(HUB, "04_results", "unified", "J50.csv"))
...
fig.tight_layout(); out = os.path.join(HUB, "04_results", "unified", "F7_J50.png"); fig.savefig(out, dpi=150); print("saved", out)

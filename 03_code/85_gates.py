...
R = os.path.join(HUB, "04_results", "menu_allocation")
ALPHA = 0.10
...
def main():
    ...
    os.makedirs(os.path.join(HUB, "04_results", "unified"), exist_ok=True)
    t.to_csv(os.path.join(HUB, "04_results", "unified", f"gates_eps{a.eps}_{a.bound}_{a.pilot_cost}_{a.baseline}_{a.judge}{'_v3' if a.gen == 'v3' else ''}.csv"), index=False)

...
Outputs: 04_results/unified/COST_MODEL_table2.csv, COST_MODEL_menu.csv, F8_cost_model.png; a printed summary.
"""
import glob, os
import numpy as np, pandas as pd

HUB = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
R = os.path.join(HUB, "04_results"); OUT = os.path.join(R, "unified")
REF = "weighted"

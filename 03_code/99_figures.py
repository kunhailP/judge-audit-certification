...
F9 calculator (rho_map/CALCULATOR_vs_map.csv). Output: 05_paper/tmlr_submission/figures/F{4..9}*.png (and copies next to the data).
"""
import glob, importlib.util, os
import numpy as np, pandas as pd

HERE = os.path.dirname(os.path.abspath(__file__)); HUB = os.path.dirname(HERE)
R = os.path.join(HUB, "04_results"); FIG = os.path.join(HUB, "05_paper", "tmlr_submission", "figures")

...
def main():
    ...
    if len(t):
        ...
        dec = (jd.frac_draws_recommend > 0.5).astype(int)
        print(f"decision 'saving > {a.tau}' (majority of pilots) vs cell truth: accuracy {(dec == jd.cell_truth).mean():.2f} on {len(jd)} judge cells; "

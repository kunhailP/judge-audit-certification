...
Writes 05_results/unified/PILOT_SWEEP_v3.csv and PILOT_SWEEP_v3.md (+ the fixed-candidate comparison).
"""
import glob, os, re, sys
import numpy as np, pandas as pd

HERE = os.path.dirname(os.path.abspath(__file__)); ROOT = os.path.dirname(HERE)
SRC = os.path.join(ROOT, "05_results", "menu_allocation"); OUT = os.path.join(ROOT, "05_results", "unified")

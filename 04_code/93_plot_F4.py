...
columns the MSE-ratio correlation. Writes 06_paper/tmlr_submission/figures/F4_gain_vs_rho.png and
05_results/ppi_gain/F4_summary.json. Run it after any ppi_gain CSV changes so that the text and the figure agree.
"""
import json, os
import numpy as np, pandas as pd

HUB = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
R = os.path.join(HUB, "05_results", "ppi_gain")
...
def main():
    ...
    fig.savefig(os.path.join(HUB, "06_paper", "tmlr_submission", "figures", "F4_gain_vs_rho.png"), dpi=200)

...
## PDF
`06_paper/tmlr_submission/main.pdf` (24 pages: main content on pages 1–12, references from page 12, appendices A–J from page 14; `\usepackage{tmlr}` without the `[accepted]` option; PDF Author/Title metadata empty).
